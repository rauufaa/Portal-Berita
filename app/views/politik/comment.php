<?php if (!$data['render'] == "") : ?>
    <section class=" max-w-6xl m-auto">
            ...
            <?php foreach ($data['komentar'] as $komentar) : ?>
                <div class="flex gap-4" id="komentar">
                    ...
                    <div class="font-medium ">
                        <div><?= $komentar['nama_pengguna'] ?></div>
                        <div class=" pt-2 text-sm text-gray-500 "><?= $komentar['isi_komentar'] ?></div>
                        <div>
        ...
        <form method="post">
            ...
            <input type="text" id="balas-id-komentar" name="balas-id-komentar">
            <input type="text" id="id-berita" name="id-berita" value="<?= $data['id_berita'] ?>">
    ...
    $(document).ready(function() {
                    ...
                    success: (datas) => {
                        datas.forEach(data => {
                            ...
                            <div class="flex gap-4">
                                ...
                                <div class="font-medium ">
                                    <div>Jese Leos</div>
                                    <div class=" pt-2 text-sm text-gray-500 ">${data.isi_komentar}</div>
        ...
        $("[data-id-komentar]").each(function(){
            $(this).on("click", function(){
                ...
                $("#to-balas").children("p").text($(this).attr("data-nama-pengguna"))
