<div class="max-w-6xl p-5 flex justify-between m-auto items-start">
    ...
    <div class="sticky top-28 max-w-sm">
        <a href="#" class="hidden sm:flex flex-row sm:w-52 md:w-80  max-w-lg items-center bg-white border border-gray-200 rounded-lg shadow  hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
