<div class="max-w-6xl">
        ...
        <?php if (stream_resolve_include_path("{$data['render']}.php")) : ?>
            <a href="<?=BASEURL."/berita/print/".$data['render']?>">Print ini lah</a>
        <?php endif ?>
    </div>
<div class="max-w-6xl p-5 flex justify-between m-auto items-start">
    ...
    <div class="sticky top-28 max-w-sm">
        <a href="#" class="hidden sm:flex flex-row sm:w-52 md:w-80  max-w-lg items-center bg-white border border-gray-200 rounded-lg shadow  hover:bg-gray-100   ">
