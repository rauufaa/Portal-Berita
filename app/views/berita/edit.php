<div class="max-w-6xl m-auto px-7">
    <?php require_once(__DIR__."../../{$data['kategori']}/{$data['judul_berita']}.php" ) ?>
</div>
<section class="max-w-6xl m-auto p-3">

    <form action="<?= BASEURL ?>/berita/editBerita/<?=$data['judul_berita']?>" method="post" enctype="multipart/form-data">
        <!-- News INPUT -->
