    ...
    <form action="<?= BASEURL ?>/berita/tambahBerita" method="post" enctype="multipart/form-data">
      ...
      <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
        <div class="grid md:grid-cols-4 bg-white py-2 px-3 ">
          <label for="judul_berita" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Judul Berita</label>
          <textarea name="judul_berita" id="judul_berita" class="col-span-3 resize-none text-3xl font-bold block p-2.5 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Judul Berita..."></textarea>
        </div>
        <div class="grid md:grid-cols-4 bg-white py-2 px-3">

          <label for="kategori_berita" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kategori Berita</label>
        ...
        <div class="grid md:grid-cols-4 bg-white py-2 px-3 ">
          <label for="lokasi_berita" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Lokasi Kejadian</label>
          <input type="text" name="lokasi_berita" id="lokasi_berita" class="col-span-3 resize-none text-base block p-2.5 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Lokasi..." />
        </div>
        <div class="grid md:grid-cols-4 bg-white py-2 px-3 ">
        ...
        <div class="grid md:grid-cols-4 bg-white py-2 px-3 ">
          ...
          <div class="col-span-3">
            <div class="flex">
              ...
              <button id="btn_delete_tumbnail" type="button" class="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
        ...
        <div class="flex items-center justify-between px-3 py-2 border dark:border-gray-600">
          <div class="flex flex-wrap items-center divide-gray-200 sm:divide-x sm:rtl:divide-x-reverse dark:divide-gray-600">
            <div class="flex items-center space-x-1 rtl:space-x-reverse sm:pe-4">
              <button id="createHeader" type="button" class="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <button id="createParagraph" type="button" class="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <button id="createPic" type="button" class="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <rect x="3" y="3" width="18" height="18" rx="2" />
        ...
        <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
          ...
          <div id="editable" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400">
            <p id="placeholder" class="w-full text-center p-10">Write an article</p>
          </div>
          <!-- <textarea id="editable" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea> -->
        </div>
      </div>
      <button id="kirim" type="submit" class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
        Publish post
      </button>
      <!-- <div class="editable">
