<div class=" max-w-6xl m-auto">
    ...
    <div class="border-b border-gray-200 " id="tab-content">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 ">
            <li class="me-2">
                <a href="<?= BASEURL ?>/user" id="profile" class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300  group">
            ...
            <li class="me-2">
                <a href="<?= BASEURL ?>/user/dashboard" id="dashboard" class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300  group">
